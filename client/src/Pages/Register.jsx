      ...
      <div className="relative flex-1 flex items-center justify-center bg-[#fffaf5] px-6 md:px-12 overflow-y-auto">
        ...
        <div className="w-full max-w-md z-10 py-10">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            {/* Password Grid (Stacked for mobile, grid-like feel) */}
            ...
            <button
              type="submit"
              className="w-full mt-4 py-4 rounded-xl bg-linear-to-r from-orange-600 to-orange-500 text-white font-bold text-lg shadow-lg shadow-orange-500/30 hover:shadow-orange-500/40 hover:-translate-y-0.5 active:translate-y-0 transition-all"
            >
              Sign Up →
            </button>
          </form>
